...
type (
	...
	// "evaltype" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_filter
	ActionEvaluationType int

	// Type of condition.
	// "conditiontype" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_filter_condition
	// "conditiontype" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_operation_condition
	ActionConditionType int

	// Condition operator.
	// "operator" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_filter_condition
	ActionFilterConditionOperator int

	// Type of operation.
	// "operationtype" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_operation
	ActionOperationType int

	// Type of operation command.
	// "type" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_operation_command
	ActionOperationCommandType int

	// Authentication method used for SSH commands.
	// "authtype" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_operation_command
	ActionOperationCommandAuthType string

	// Target on which the custom script operation command will be executed.
	// "execute_on" in https://www.zabbix.com/documentation/5.0/manual/api/reference/action/object#action_operation_command
	ActionOperationCommandExecutorType string
)
...
type Action struct {
	...
	PauseSuppressed PauseType  `json:"pause_suppressed,omitempty"`
...
type ActionOperationCommand struct {
	...
	ExecuteOn   ActionOperationCommandExecutorType `json:"execute_on,omitempty"`
...
// https://www.zabbix.com/documentation/5.0/manual/api/reference/action/get
...
// https://www.zabbix.com/documentation/5.0/manual/api/reference/action/create
...
// https://www.zabbix.com/documentation/5.0/manual/api/reference/action/update
...
// https://www.zabbix.com/documentation/5.0/manual/api/reference/action/delete
