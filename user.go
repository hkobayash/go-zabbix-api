...
type (
	...
	// "debug_mode" in https://www.zabbix.com/documentation/5.0/manual/api/reference/user/object#user_group
	UserType int
)
...
// https://www.zabbix.com/documentation/5.0/manual/api/reference/user/object
type User struct {
...
// https://www.zabbix.com/documentation/5.0/manual/api/reference/user/get
